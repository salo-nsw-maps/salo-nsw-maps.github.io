...
# only show tiles within sites
all_sites = df_sites.geometry.unary_union
df55 = df55[df55.intersects(all_sites)]
...
# setup map
m = folium.Map(location = [-32.67824334, 150.95007370], zoom_start = 6)
